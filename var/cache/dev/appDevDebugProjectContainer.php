...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('cYCCMebwyg', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('v8HNCctkwc', 0, 'jVmCUCucteJ0TyCAmUi+mw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_6ac892971b8b99c4868385376a2795310a292f0964725a76aea0bda4cf1ed788');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('80g4a0SvDi', NULL, 'jVmCUCucteJ0TyCAmUi+mw', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\RegisterBundle/Resources/views'), 'Register');
        $instance->addPath(($this->targetDirs[3].'\\src\\CustomerBundle/Resources/views'), 'Customer');
        $instance->addPath(($this->targetDirs[3].'\\src\\OperatorBundle/Resources/views'), 'Operator');
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('n-om-DACjR', 0, 'jVmCUCucteJ0TyCAmUi+mw', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58543220118aa5.09458857')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'RegisterBundle' => 'RegisterBundle\\RegisterBundle',
                'CustomerBundle' => 'CustomerBundle\\CustomerBundle',
                'OperatorBundle' => 'OperatorBundle\\OperatorBundle',
