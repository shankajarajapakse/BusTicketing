...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'customer_homepage');
            }

            return array (  '_controller' => 'CustomerBundle\\Controller\\DefaultController::indexAction',  '_route' => 'customer_homepage',);
        }

        // register_homepage
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'register_homepage');
            }

            return array (  '_controller' => 'RegisterBundle\\Controller\\DefaultController::indexAction',  '_route' => 'register_homepage',);
        }
